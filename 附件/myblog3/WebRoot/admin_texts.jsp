		...
		<div class="row">
        		...
        		<div class="col-lg-12">
                	<div class="wrapper wrapper-content animated fadeInRight">
						<form action="<%=base %>admin_text.jsp" method="post">
                   			<div  align="center">
                   				<button title="Create new cluster" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i><span class="bold" >添加文章</span></button>
                   			</div>
						...
						%>
		                   ...
		                   <div class="row">
		                       <div class="col-md-6">
			                       <a data-toggle="collapse" href="" class="faq-question"><%=post.getTitle() %></a>
		                           <small><i class="fa fa-clock-o"></i> <%=post.getCreatedAt() %></small>
		                       </div>
		                       <div class="col-md-2">
		                       		<a href="<%=base %>admin/PostView?id=<%=post.getId() %>"><button type="button" class="btn btn-w-m btn-info">查看</button></a>
		                       </div>
		                       <div class="col-md-2">
		                       		<a href="<%=base %>admin/PostEdit?id=<%=post.getId() %>"><button type="button" class="btn btn-w-m btn-info">编辑</button></a>
		                       </div>
		                       <div class="col-md-2">
		                       		<form action="<%=base %>admin/PostDelete" method="post">
                   ...
                   <div align="center">
						[<a href="<%=base %>admin/Post">上一页</a>]
					 	[<a href="<%=base %>admin_textss.jsp">下一页</a>]
				   </div>
                </div>
