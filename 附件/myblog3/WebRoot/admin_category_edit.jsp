                            		...
                            		<div class="col-sm-10">
                            			<div class="row">
                           				<form action="<%=base %>admin/CategoryEdit" method="post">
                           					...
                           					<div class="col-md-3"><button title="Create new cluster" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i><span class="bold">修改分类</span></button></div>
